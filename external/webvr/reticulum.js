...
var Reticulum = (function () {
    ...
    var gazeOver = function(threeObject, ind) {
        ...
        if (threeObject.onGazeOver != null) {
            threeObject.onGazeOver(ind);
        }
    };

    var gazeLong = function( threeObject, ind ) {
        var distance;
    ...
    return {
        ...
        remove: function (objectname) {
            var remObj = scene.getObjectByName(objectname);
            var index = collisionList.indexOf(remObj);
            //remObj.reticulumData.gazeable = false;
